      ...
      <div class="col w-full">
        <div class="card bg-base-100 w-full shadow-xl rounded-md">
            <div class="card-body">
                ...
                <p class="text-lg mt-8">{{ $post->deskripsi }}</p>
            </div>
          </div>
            <div class="card bg-base-100 w-full shadow-xl mt-6 rounded-md">
              <div class="card-body">
                ...
                <div class="justify-start">
                      ...
                      <div class="container">
                      <div class="mb-4 mt-4 outline outline-info rounded-md p-4">
                          <strong class="text bg-info rounded-sm pl-2 pr-2">{{ $comment->username }}</strong>
                          <p>{{ $comment->comment }}</p>
                          <small>{{ \Carbon\Carbon::parse($comment->created_at)->locale('id')->isoFormat('dddd, D MMMM Y | hh:mm') }} WIB</small>
                        </div></div>
                          @endforeach              
                </div>
            </div>
